...
export const ModelPicker = ({ selectedModel, setSelectedModel }: ModelPickerProps) => {
  ...
  return (
    <div className="absolute bottom-2 left-2 z-10">
      ...
      >
        <SelectTrigger 
          className="max-w-[200px] sm:max-w-fit sm:w-56 px-2 sm:px-3 h-8 sm:h-9 rounded-full group border-primary/40 bg-primary/15 hover:bg-primary/20 dark:bg-primary/20 dark:hover:bg-primary/30 transition-all duration-200 ring-offset-background focus:ring-2 focus:ring-primary/30 focus:ring-offset-2"
        >
          <SelectValue 
        ...
        <SelectContent
          align="start"
          className="bg-background/95 dark:bg-muted/95 border-border/80 rounded-lg overflow-hidden p-0 w-[280px] sm:w-[350px] md:w-[515px]"
        >
