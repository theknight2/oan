...
import { ArrowRight, Bot, Database, Sparkles, Globe, BarChart2 } from "lucide-react";
...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <div className="relative w-full py-20 bg-background">
        <div className="container px-4 mx-auto z-10 relative">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <div className="pt-6">
              <Link href="/chat" className="inline-flex items-center justify-center rounded-lg bg-primary px-6 py-3 text-base font-medium text-primary-foreground">
      ...
      <div className="w-full py-16 bg-background relative z-10">
        <div className="container px-4 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="flex flex-col items-center text-center p-6 rounded-xl bg-card/10 border border-border/40">
      ...
      <div className="w-full py-16 bg-background relative z-10">
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="flex flex-col rounded-2xl p-8 border border-border/60 bg-card/30">
              ...
              <Link 
                href="/chat"
                className="inline-flex items-center justify-center rounded-lg bg-primary/90 px-5 py-2.5 text-sm font-medium text-primary-foreground self-start mt-auto"
              >
      ...
      <div className="w-full py-16 bg-background relative z-10">
        <div className="container px-4 mx-auto">
          <div className="max-w-3xl mx-auto text-center p-8 rounded-2xl border border-border/40 bg-card/10">
            ...
            <Link 
              href="/chat"
              className="inline-flex items-center justify-center rounded-lg bg-primary px-6 py-3 text-base font-medium text-primary-foreground"
            >
